...
// ZNSName is a name binding that maps a Fully Qualified Agent Name (FQAN) to an agent_id.
...
type ZNSName struct {
	...
	AgentName       string   `json:"agent_name" db:"agent_name"`             // e.g., "doc-translator"
	...
	AgentID         string   `json:"agent_id" db:"agent_id"`                 // agdns:<hash>
...
// ZNSVersion tracks a specific version of an agent bound to a FQAN.
type ZNSVersion struct {
	FQAN         string `json:"fqan" db:"fqan"`
	Version      string `json:"version" db:"version"`
	AgentID      string `json:"agent_id" db:"agent_id"` // agent_id at this version
